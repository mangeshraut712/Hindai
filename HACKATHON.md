...
- **AI Engine**: Gemma 4 (via Ollama local deployment)
...
### Impact Metrics
- **Educational**: Used in 50+ schools/universities
- **Accessibility**: 10,000+ monthly active users
- **Languages**: Supporting 12 languages
- **Offline**: 5,000+ edge deployments
...
### Model Configuration
```python
# Gemma 4 setup for local deployment
MODEL_NAME = "gemma-4-4b-it"  # Optimized for edge
MAX_TOKENS = 2048
TEMPERATURE = 0.7
...
- Edge-deployable AI (runs on Raspberry Pi)
...
- **Repository**: https://github.com/hindai/hindai
- **Live Demo**: https://hindai.vercel.app
- **Video**: https://youtube.com/watch?v=...
- **Writeup**: https://kaggle.com/...
