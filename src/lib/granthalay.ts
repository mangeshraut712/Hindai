...
export const GRANTHALAY_HALLS: GranthalayHall[] = [
  {
    ...
    sanskrit: "पोथी",
    description:
      "Marathi original ovis where stored, Marathi story guides where the original ovis are still missing, and the Sanskrit Durga Saptashati patha.",
    ...
    shelves: [
      {
        ...
        href: "/shivlilamrit",
        depth: "full",
        note: "Complete 15 adhyayas of original Marathi ovis",
      ...
      },
      {
        ...
        href: "/harivijay",
        depth: "katha",
        note: "36 Marathi chapter guides; original ovis not stored",
        media: ["text", "image", "ask"],
      },
      {
        title: "Ramvijay",
        ...
        href: "/ramvijay",
        depth: "katha",
        note: "17 Marathi chapter guides; original ovis not stored",
        media: ["text", "image", "ask"],
      },
      {
        title: "Haripath",
        ...
        href: "/haripaat",
        depth: "katha",
        note: "10 Marathi reading leaves; traditional abhang text not stored",
        media: ["text", "image", "ask"],
      },
      {
        ...
        depth: "full",
        note: "Original Sanskrit patha in Devanagari, including all 13 adhyayas",
