...
export const studyPaths: StudyPath[] = [
  {
    ...
    summary:
      "A beginner-friendly route into Shruti, Smriti, and the Bhagavad Gita.",
    ...
    steps: [
      {
        ...
        description:
          "Understand Shruti, Smriti, Vedas, Upanishads, Puranas, and Itihasa.",
        href: "/structure/",
      },
      {
        id: "student-gita",
        ...
        description:
          "Use Bhagavad Gita 2.47 as an entry point into Karma Yoga.",
      ...
      },
      {
        ...
        description:
          "Summarize the verse in plain English and extract key terms.",
  ...
  },
  {
    ...
    summary:
      "A compare-texts route built for classroom framing and discussion prompts.",
    ...
    steps: [
      {
        ...
        description:
          "Review the catalog before selecting texts for comparison.",
        href: "/contents/",
      },
      {
        ...
        description:
          "Compare Bhagavad Gita and Yoga Sutras on discipline and inner steadiness.",
      ...
      },
      {
        ...
        description:
          "Use Rigveda as a contrastive shelf for poetry, invocation, and cosmology.",
        href: "/rigveda/",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        description:
          "Open Ramayana as a story of exile, kingship, and devotion.",
        href: "/ramayana/",
      },
      {
      ...
      },
      {
        ...
        description:
          "Generate a reflective comparison on devotion across the two texts.",
