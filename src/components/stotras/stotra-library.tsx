...
const getTypeIcon = (type: StotraItem["type"]) => {
  switch (type) {
    case "sahasranama":
...
const getTypeColor = (type: StotraItem["type"]) => {
  switch (type) {
    case "sahasranama":
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-6 text-muted-foreground">
                  ...
                  qualities. These texts form the core of Hindu devotional practice, used for
                  worship, meditation, and spiritual growth.
                </p>
                <ul
                  className="grid list-none grid-cols-1 gap-4 p-0 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3"
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {selectedStotra.sampleNames.map((name, index) => (
                          <div
                            key={`${name.sanskrit}-${name.meaning}`}
